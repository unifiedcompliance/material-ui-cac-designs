...
function createData(domain, isPrimary) {
...
function DomainTable() {
  ...
  const domainInput = React.useRef();
  ...
  const [domainList, setDomainList] = React.useState([
    createData("microsoft.com", true),
    createData("microsoft.com", false),
  ]);
  ...
  const setDomainPrimary = (index) => {
    let domainList = domainList.map((row, i) => {
      return {
        domain: row.domain,
        isPrimary: index === i,
      };
    ...
    <div>
      ...
      >
        <div style={modalStyle} className={classes.paper}>
          <ModalTitle id="simple-modal-title">Add Domain</ModalTitle>
